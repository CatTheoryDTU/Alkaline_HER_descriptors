...
set xlabel '$\Delta G^{fcc}_{H} -\frac{b}{a}(U_{PZC})$'
...
plot \
	"<paste ../PZCs.txt ../vac_HBEs.txt ../volmers.txt ../numbers.txt" using (-0.58*($1-4.44)+$2):3:4 w points lc 'black' ps 2 pt variable notitle, \
	"<paste ../PZCs.txt ../vac_HBEs.txt ../heyrovskys.txt ../numbers.txt" using (-0.58*($1-4.44)+$2):3:4 w points ps 2 pt variable lc 7 notitle, \
	"<paste ../PZCs.txt ../vac_HBEs.txt ../tafels.txt ../numbers.txt" using (-0.58*($1-4.44)+$2):3:4 w  points ps 2 pt variable lc 6 notitle, \
...
set label 2 sprintf('\tiny{Heyrovsky, $R^2 = %1.2f$}',htophey_correlation**2) at 0.1,1.08 rotate by atan(2*htophey_slope/1.3)/pi*180.0+5 font subtitlefont textcolor lt 7 front
