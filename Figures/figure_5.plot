...
plot \
	...
	"<paste fig5x.txt fig5a.txt" u 1:5 w l lc 'dark-green' lw 3.0 dashtype '-.' notitle, \
	"<paste fig5x.txt fig5a.txt" u 1:4 w l lc 'blue' lw 3.0 notitle, \
	"<paste fig5x.txt fig5a.txt" u 1:6 w l lc 'purple' lw 3.0 notitle, \
	"<paste fig5x.txt fig5a.txt" u 1:7 w l lc 'blue' lw 3.0 dashtype '.' notitle
set ylabel ""
set ytics format ""
set label 1 '$\Delta G^{fcc}_H-0.52U_{PZC}$' at -1.9, 1.0 textcolor 'dark-green' front
...
plot \
	...
	"<paste fig5x.txt fig5b.txt" u 1:5 w l lc 'dark-green' lw 3.0 dashtype '-.' notitle, \
...
plot \
	...
	"<paste fig5x.txt fig5c.txt" u 1:5 w l lc 'dark-green' lw 3.0 dashtype '-.' notitle, \
	"<paste fig5x.txt fig5c.txt" u 1:4 w l lc 'blue' lw 3.0 notitle, \
	"<paste fig5x.txt fig5c.txt" u 1:6 w l lc 'purple' lw 3.0 notitle, \
	"<paste fig5x.txt fig5c.txt" u 1:7 w l lc 'blue' lw 3.0 dashtype '.' notitle
unset multiplot
