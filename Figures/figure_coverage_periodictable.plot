...
set terminal epslatex color colortext size 5in,3.0in "cmss" standalone
...
unset cbtics
set x2label r"$\\theta_H$" offset screen 0.02,0
set x2tics ("0.01" 10, "1" 0.1, "0.1" 1) offset graph 0,-0.03
set label 2 at screen 0.05,0.95 'a)' front
...
set cbrange [0.01:1] 
set cblabel r"$\\theta_H$" offset screen 0,0.28
...
set title 'Rh' offset -4.5,-2.5 textcolor 'white'
...
unset xlabel
set ylabel "pH"
set title 'Ir' offset -4.5,-2.5 textcolor 'white'
...
set format y '';
set format x ''; 
set title 'Ni' offset -4.5,-2.5 textcolor 'white'
set arrow 1 from -0.413,7 to -0.826,14 nohead lc 'white' lw 5 front
splot "../results/Ni/coverage.dat" using 1:2:3 with pm3d notitle
#Pd
set title 'Pd' offset -4.5,-2.5 textcolor 'white'
splot "../results/Pd/coverage.dat" using 1:2:3 with pm3d notitle
#Pt
set format x "%1.1f"
set xlabel "U vs SHE (V)" 
set title 'Pt' offset -4.5,-2.5 textcolor 'white'
...
set title 'Ag' offset -4.5,-2.5 textcolor 'black'
splot "../results/Ag/coverage.dat" using 1:2:3 with pm3d notitle 
#Au
set title 'Au' offset -4.5,-2.5
