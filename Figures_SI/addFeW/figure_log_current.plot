...
#set output "LSVs.png"
set terminal epslatex color colortext size 4in,3in "cmss" standalone
...
stats "<awk '$2==13.0 && $1<-1.000' Fe_current.dat" using ($1-pH):(log10(-1*$3)) prefix "Fe"
stats "<awk '$2==13.0 && $1<-1.000' W_current.dat" using ($1-pH):(log10(-1*$3)) prefix "W"
...
set label 9 sprintf('\scriptsize Fe %3.0f mV/dec',1000/Fe_slope) at -0.65,10**(0.60+(-0.65)*Fe_slope+Fe_intercept) rotate by r(Fe_slope)-12 center textcolor lt 8
set label 10 sprintf('\scriptsize W %1.2e mV/dec',1000/W_slope) at -0.65,10**(0.60+(-0.65)*W_slope+W_intercept) rotate by r(W_slope)-12 center textcolor lt 8
plot "<awk '$2==13.0' ../../results/Ag/current.dat" using ($1-pH):(a*(-1.0*$3)) w l lw 2.0 notitle, \
	...
	"<awk '$2==13.0' Fe_current.dat" using ($1-pH):(a*(-1.0*$3)) w l lw 2.0 dt 2 notitle, \
	"<awk '$2==13.0' W_current.dat" using ($1-pH):(a*(-1.0*$3)) w l lw 2.0 dt 2 notitle
