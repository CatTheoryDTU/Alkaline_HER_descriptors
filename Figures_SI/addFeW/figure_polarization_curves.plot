...
set output "Figure_Polarization_curves_FeW.tex"
...
plot "<awk '$2==13.0' ../../results/Ag/current.dat" using ($1-pH):3 w l lw 5.0 title 'Ag' at beginning, \
	...
	"<awk '$2==13.0' Fe_current.dat" using ($1-pH):3 w l lw 5.0 linecolor 'sienna4' title 'Fe' at beginning, \
	"<awk '$2==13.0' W_current.dat" using ($1-pH):3 w l lw 5.0 linecolor 'royalblue' title 'W' at beginning
