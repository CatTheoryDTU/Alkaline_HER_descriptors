...
#Cu
unset xlabel; set format x ''
set title 'Cu' offset elemxoff, elemyoff textcolor 'white'
splot "../results/Cu/rate_control.dat" using 1:2:9 with pm3d notitle

#Ag
set title 'Ag' offset elemxoff, elemyoff textcolor 'white'
splot "../results/Ag/rate_control.dat" using 1:2:9 with pm3d notitle

#Au
set format x '%1.1f' ;
set title 'Au' offset elemxoff, elemyoff textcolor 'white'
