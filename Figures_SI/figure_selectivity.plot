...
set label 1 '0V vs RHE'  at -0.5195,10.5 textcolor 'black' rotate by atan(3.5*1.75*-0.59)/pi*180+9 center front #font ticsfont 
...
set label 1 '0V vs RHE'  at -0.5195,10.5 textcolor 'white' rotate by atan(3.5*1.75*-0.59)/pi*180+9 center front #font ticsfont 
unset colorbox
#set format x "%1.1f"
set format y "%2.0f"
