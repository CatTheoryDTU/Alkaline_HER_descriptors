...
set output "Descriptors_Activation_Energies_-0.5V.tex"
load 'turbo.pal'
...
set print '/dev/null'
stats "<paste HBEs.txt volmers_-0.5V.txt" u 1:2 prefix "hbevol"
stats "<paste HBEs.txt heyrovskys_-0.5V.txt" u 1:2 prefix "hbehey"
stats "<paste HBEs.txt tafels.txt" u 1:2 prefix "hbetaf"
stats "<paste PZCs.txt volmers_-0.5V.txt" u ($1-4.44):2 prefix "pzcvol"
stats "<paste PZCs.txt heyrovskys_-0.5V.txt" u ($1-4.44):2 prefix "pzchey"
stats "<paste PZCs.txt tafels.txt" u ($1-4.44):2 prefix "pzctaf"
stats "<paste couplings.txt volmers_-0.5V.txt" u 1:2 prefix "coupvol"
stats "<paste couplings.txt heyrovskys_-0.5V.txt" u 1:2 prefix "couphey"
stats "<paste couplings.txt tafels.txt" u 1:2 prefix "couptaf"
stats "<paste dbandcenters.txt volmers_-0.5V.txt" u 1:2 prefix "dbandvol"
stats "<paste dbandcenters.txt heyrovskys_-0.5V.txt" u 1:2 prefix "dbandhey"
...
fit f2(x,y) "<paste PZCs.txt HBEs.txt volmers_-0.5V.txt" u 1:2:3 via f21,f22,f23
fit g2(x,y) "<paste PZCs.txt HBEs.txt heyrovskys_-0.5V.txt" u 1:2:3 via g21,g22,g23
fit h2(x,y) "<paste PZCs.txt HBEs.txt tafels.txt" u 1:2:3 via h21,h22,h23
stats "<paste PZCs.txt HBEs.txt volmers_-0.5V.txt" using (f2($1,$2)):3 prefix "VOLM"
stats "<paste PZCs.txt HBEs.txt heyrovskys_-0.5V.txt" using (g2($1,$2)):3 prefix "HEY"
...
plot \
	'<paste HBEs.txt volmers_-0.5V.txt numbers.txt' u 1:2:3 with points lc 'black' pointtype variable ps 2 notitle, \
	'<paste HBEs.txt heyrovskys_-0.5V.txt numbers.txt' u 1:2:3 w points ps 2 pt variable lc 7 notitle, \
...
unset key
plot \
	'<paste PZCs.txt volmers_-0.5V.txt numbers.txt' u ($1-4.44):2:3 w points lc 'black' ps 2 pt variable notitle, \
	'<paste PZCs.txt heyrovskys_-0.5V.txt numbers.txt' u ($1-4.44):2:3 w points ps 2 pt variable lc 7 notitle, \
...
plot \
	"<paste PZCs.txt HBEs.txt volmers_-0.5V.txt numbers.txt" using (f21*($1-4.44)/f22+$2):3:4 w points lc 'black' ps 2 pt variable notitle, \
	"<paste PZCs.txt HBEs.txt heyrovskys_-0.5V.txt numbers.txt" using (g21*($1-4.44)/g22+$2):3:4 w points ps 2 pt variable lc 7 notitle, \
