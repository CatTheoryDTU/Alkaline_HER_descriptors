...
plot \
	"<paste PZCs.txt HBEs.txt metals.txt" using ($1-4.44):2:(sprintf("%s",stringcolumn(3))) every 2::0 w labels point pt 7 offset char -1,0.5 notitle, \
	"<paste PZCs.txt HBEs.txt metals.txt" using ($1-4.44):2:(sprintf("%s",stringcolumn(3))) every 2::1 w labels point pt 7 offset char 0.5,-1 notitle, \
