...
set cbrange [-10:10]
plot \
	"<paste PZCs.txt HBEs.txt pH14RHE-0.2_activity.txt metals.txt" using ($1-4.44):2:(log10($3)) palette pt 7 notitle, \
	"<paste PZCs.txt HBEs.txt pH14RHE-0.2_activity.txt metals.txt" using ($1-4.44):2:(sprintf("%s",stringcolumn(4))):(log10($3)) w labels offset char 1,1 textcolor palette notitle, \
