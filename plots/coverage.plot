...
set multiplot layout 3,3 margins 0.10, 0.85, 0.2, 0.925 title "Coverage" font "Helvetica,16"
...
set arrow 1 from -0.413,7 to -0.826,14 nohead lc 'white' lw 2 front
set label 1 'Reversible Hydrogen Electrode'  at -0.7,13.75 textcolor 'white' font ticsfont rotate by -77.5 front 
unset colorbox
#set format x "%1.1f"
set format y "%2.0f"
